...
with DAG(
    ...
    raw_city_park_info_table = "city_park_info_raw"
    raw_city_park_info_database_name = "cloudtree_raw_db"
    raw_city_park_info_sql_file_name = f"create_table_{raw_city_park_info_table}"
    raw_city_park_info_fetch_s3_task_id = f"fetch_sql_{raw_city_park_info_sql_file_name}"
    raw_city_park_info_table_ddl = fetch_query_s3(
        raw_city_park_info_fetch_s3_task_id, f"create_table_{raw_city_park_info_table}"
    )
    raw_city_park_info_create_table_by_ddl = create_table(
        raw_city_park_info_fetch_s3_task_id, raw_city_park_info_database_name
    )

    trans_city_park_info_table = "city_park_info"
    trans_city_park_info_database_name = "cloudtree_transformed_db"
    trans_city_park_info_sql_file_name = f"create_table_{trans_city_park_info_table}"
    trans_city_park_info_fetch_s3_task_id = f"fetch_sql_{trans_city_park_info_sql_file_name}"
    trans_city_park_info_table_ddl = fetch_query_s3(
        trans_city_park_info_fetch_s3_task_id, f"create_table_{trans_city_park_info_table}"
    )
    trans_city_park_info_create_table_by_ddl = create_table(
        trans_city_park_info_fetch_s3_task_id, trans_city_park_info_database_name
    )

    msck_city_park_info_raw = update_data_catalog("cloudtree_raw_db", "city_park_info_raw")
    run_glue_city_park_info = run_glue_job("city_park_info_job")
    msck_city_park_info_trans = update_data_catalog("cloudtree_transformed_db", "city_park_info")

    # task 의존성 설정

    (
        raw_city_park_info_table_ddl
        >> raw_city_park_info_create_table_by_ddl
        >> trans_city_park_info_table_ddl
        >> trans_city_park_info_create_table_by_ddl
        >> msck_city_park_info_raw
        >> run_glue_city_park_info
        >> msck_city_park_info_trans
    )
