...
with DAG(
    ...
    raw_best_loan_list_table_ddl = fetch_query_s3(
        raw_best_loan_list_fetch_s3_task_id, f"create_table_{raw_best_loan_list_table}"
    )
    raw_best_loan_list_create_table_by_ddl = create_table(
    ...
    trans_best_loan_list_table_ddl = fetch_query_s3(
        trans_best_loan_list_fetch_s3_task_id, f"create_table_{trans_best_loan_list_table}"
    )
    trans_best_loan_list_create_table_by_ddl = create_table(
