...
with DAG(
    dag_id="initialLoading_lib_L1",
    description="도서관정보(lib) 재적재. L1까지 ETL",
    ...
    delete_trans_data = s3h.task_delete_transformed_data([cfg.TRANS_PREFIX['lib']])
    ...
    (start_task >> delete_trans_data >> etl_lib >> end_task >> trigger_next_ETL)
