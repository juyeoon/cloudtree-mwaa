...
with DAG(
    ...
    raw_subway_station_loc_table_ddl = fetch_query_s3(
        raw_subway_station_loc_fetch_s3_task_id, f"create_table_{raw_subway_station_loc_table}"
    )
    raw_subway_station_loc_create_table_by_ddl = create_table(
    ...
    trans_subway_station_loc_table_ddl = fetch_query_s3(
        trans_subway_station_loc_fetch_s3_task_id, f"create_table_{trans_subway_station_loc_table}"
    )
    trans_subway_station_loc_create_table_by_ddl = create_table(
        trans_subway_station_loc_fetch_s3_task_id, trans_subway_station_loc_database_name
    )

    invoke_subway_station_loc_API = invoke_lambda("getSubwayStationLocAPI", {"key": seoul_key})
    msck_subway_station_loc_raw = update_data_catalog("cloudtree_raw_db", "subway_station_loc_raw")
    run_glue_subway_station_loc = run_glue_job("subway_station_loc_job")
    msck_subway_station_loc_trans = update_data_catalog("cloudtree_transformed_db", "subway_station_loc")

    # task 의존성 설정

    (
        raw_subway_station_loc_table_ddl
        >> raw_subway_station_loc_create_table_by_ddl
        >> trans_subway_station_loc_table_ddl
        >> trans_subway_station_loc_create_table_by_ddl
        >> invoke_subway_station_loc_API
        >> msck_subway_station_loc_raw
        >> run_glue_subway_station_loc
        >> msck_subway_station_loc_trans
    )
