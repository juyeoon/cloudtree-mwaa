...
"""
# task 실패, retry 실패하면 slack으로 메시지 보내는 DAG
"""
...
with DAG(
    ...
    failure_task = PythonOperator(
        task_id="task_3",
        python_callable=lambda: 1 / 0,  # 실패를 유도하는 작업
        retries=2,  # 태스크별 재시도 횟수 설정
        retry_delay=timedelta(minutes=1),  # 태스크별 재시도 대기 시간 설정
